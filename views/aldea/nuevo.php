...
<?= $frm->open_form(["method"=>"post","id"=>"formulario_aldeas"]); ?>
	...
	<div class="body-content">
		<?= $frm->textInput($model, "nombre_aldea"); ?>

		<?= $frm->textInput($model, "ubicacion"); ?>

		<br>

		<?= $frm->dropDownList("id_zona",ArrayHelper::map($registros,'cod_zona','descripcion'), "<b>Eje</b>","select_eje")."<br>"; ?>
