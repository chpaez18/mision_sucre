...
<?= $frm->open_form(["method"=>"post","id"=>"formulario_carreras"]); ?>
	...
	<div class="head">
		<center><h3><?php echo $this->titulo . ": ". $model->nombre_carrera; ?></h3></center>
	</div>	

	<div class="body-content">
		<?= $frm->textInput($model, "nombre_carrera",["value"=>$model->nombre_carrera]); ?>

		<?= $frm->textInput($model, "tipo",["value"=>$model->tipo]); ?>
