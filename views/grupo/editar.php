...
<?= $frm->open_form(["method"=>"post","id"=>"formulario_grupos"]); ?>
	...
	<div class="head">
		<center><h3><?php echo $this->titulo . ": ". $model->nombre; ?></h3></center>
	</div>	

	<div class="body-content">
		<?= $frm->textInput($model, "nombre",["value"=>$model->nombre]); ?>

<br>
		<?= $frm->dropDownList("id_carrera",ArrayHelper::map($registros,'cod_carrera','nombre_carrera'), "<b>Carrera</b>","select_carrera",0, $model->id_carrera); ?> 
