...
//validaciones javascript de las vistas lado del cliente
    ...
    $("#formulario_estudiantes").validate({
      ...
      messages:
      {
          ...
          ano:{required:"Debe rellenar este campo", minlength:"Este campo acepta mínimo 4 Caracteres"},
          sexo_estudiante:{required:"Debe seleccionar un género"},
    ...
    $("#formulario_coordinadores").validate({
      ...
      messages:
      {
          ...
          cedula:{required:"Debe rellenar este campo", digits:"Escriba solo números enteros", minlength:"Este campo acepta mínimo 7 Digitos",maxlength:"Este campo acepta máximo 8 Digitos"},
          ced_coordinador:{required:"Debe rellenar este campo", digits:"Escriba solo números enteros", minlength:"Este campo acepta mínimo 7 Digitos", maxlength:"Este campo acepta máximo 8 Digitos"},
